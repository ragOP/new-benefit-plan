...
var campaignID = "66eacdcb2b9cbcee931578aa";
...
var initialSrc = "https://go.lifebenefitsusa.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("go.lifebenefitsusa.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://go.lifebenefitsusa.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://go.lifebenefitsusa.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
